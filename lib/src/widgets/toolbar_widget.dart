...
import 'package:html_editor_enhanced/src/widgets/custom_button.dart';
import 'package:html_editor_enhanced/src/widgets/custom_input_field.dart';
...
class ToolbarWidgetState extends State<ToolbarWidget> {
        ...
        if (t is FontButtons) {
          for (var i = 0; i < _fontSelected.length; i++) {
            ...
            if (t.getIcons1()[i].icon == Icons.format_underline) {
              if (colorList.toString().contains('rgb(35, 82, 124)') || colorList.toString().contains('rgb(51, 122, 183)')) {
                debugPrint('URL');
                _linkSelected = true;
              } else if (colorList.toString().contains('rgb(0, 0, 0)')) {
  ...
  List<Widget> _buildChildren() {
    ...
    for (var t in widget.htmlToolbarOptions.defaultToolbarButtons) {
          ...
          child: CustomDropdownButtonHideUnderline(
            child: CustomDropdownButton<String>(
              ...
              onChanged: (String? changed) async {
                ...
                if (changed != null) {
                  var proceed =
                      await widget.htmlToolbarOptions.onDropdownChanged?.call(DropdownType.style, changed, updateSelectedItem) ??
                          true;
                  if (proceed) {
              ...
              child: CustomDropdownButton<double>(
                ...
                items: [
                  CustomDropdownMenuItem(
                    value: 1,
                    child: PointerInterceptor(
                        child: Text("${_fontSizeUnitSelectedItem == "px" ? "11" : "8"} $_fontSizeUnitSelectedItem")),
                  ),
                  CustomDropdownMenuItem(
                    value: 2,
                    child: PointerInterceptor(
                        child: Text("${_fontSizeUnitSelectedItem == "px" ? "13" : "10"} $_fontSizeUnitSelectedItem")),
                  ),
                  CustomDropdownMenuItem(
                    value: 3,
                    child: PointerInterceptor(
                        child: Text("${_fontSizeUnitSelectedItem == "px" ? "16" : "12"} $_fontSizeUnitSelectedItem")),
                  ),
                  CustomDropdownMenuItem(
                    value: 4,
                    child: PointerInterceptor(
                        child: Text("${_fontSizeUnitSelectedItem == "px" ? "19" : "14"} $_fontSizeUnitSelectedItem")),
                  ),
                  CustomDropdownMenuItem(
                    value: 5,
                    child: PointerInterceptor(
                        child: Text("${_fontSizeUnitSelectedItem == "px" ? "24" : "18"} $_fontSizeUnitSelectedItem")),
                  ),
                  CustomDropdownMenuItem(
                    value: 6,
                    child: PointerInterceptor(
                        child: Text("${_fontSizeUnitSelectedItem == "px" ? "32" : "24"} $_fontSizeUnitSelectedItem")),
                  ),
                  CustomDropdownMenuItem(
                    value: 7,
                    child: PointerInterceptor(
                        child: Text("${_fontSizeUnitSelectedItem == "px" ? "48" : "36"} $_fontSizeUnitSelectedItem")),
                  ),
                ],
          ...
          toolbarChildren.add(ToggleButtons(
            ...
            onPressed: (int index) async {
              ...
              if (t.getIcons1()[index].icon == Icons.format_bold) {
                var proceed =
                    await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.bold, _fontSelected[index], updateStatus) ??
                        true;
                if (proceed) {
              ...
              if (t.getIcons1()[index].icon == Icons.format_clear) {
                var proceed =
                    await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.clearFormatting, null, null) ?? true;
                if (proceed) {
          ...
          toolbarChildren.add(ToggleButtons(
            ...
            onPressed: (int index) async {
              ...
              if (t.getIcons()[index].icon == Icons.format_list_bulleted) {
                var proceed =
                    await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.ul, _listSelected[index], updateStatus) ??
                        true;
                if (proceed) {
              ...
              if (t.getIcons()[index].icon == Icons.format_list_numbered) {
                var proceed =
                    await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.ol, _listSelected[index], updateStatus) ??
                        true;
                if (proceed) {
          ...
          toolbarChildren.add(ToggleButtons(
            ...
            onPressed: (int index) async {
              if (t.getIcons2()[index].icon == Icons.format_indent_increase) {
                var proceed =
                    await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.increaseIndent, null, null) ?? true;
                if (proceed) {
              ...
              if (t.getIcons2()[index].icon == Icons.format_indent_decrease) {
                var proceed =
                    await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.decreaseIndent, null, null) ?? true;
                if (proceed) {
            ...
            child: CustomDropdownButtonHideUnderline(
              child: CustomDropdownButton<String>(
                ...
                onChanged: (String? changed) async {
                  if (changed != null) {
                    var proceed =
                        await widget.htmlToolbarOptions.onDropdownChanged?.call(DropdownType.caseConverter, changed, null) ??
                            true;
                    if (proceed) {
                      if (kIsWeb) {
      ...
      if (t is InsertButtons && (t.audio || t.video || t.otherFile || t.picture || t.hr || t.table)) {
        toolbarChildren.add(ToggleButtons(
          constraints: BoxConstraints.tightFor(
            width: widget.htmlToolbarOptions.toolbarItemHeight - 2,
            height: widget.htmlToolbarOptions.toolbarItemHeight - 2,
      ...
      for (var i = 0; i < widget.htmlToolbarOptions.customToolbarInsertionIndices.length; i++) {
        if (widget.htmlToolbarOptions.customToolbarInsertionIndices[i] > toolbarChildren.length) {
          ...
          toolbarChildren.insert(
              widget.htmlToolbarOptions.customToolbarInsertionIndices[i], widget.htmlToolbarOptions.customToolbarButtons[i]);
        }
      }
    } else {
